...
print(f"Demographic table: {demographic_table}")
print(f"Lab Result table: {lab_results_table}")
print(f"Physicals Result table: {physicals_results_table}")
print(f"Feature table: {feature_table_name}")
print(f"Model Registry URI: {model_registry_uri}")
print(f"Model Name(Non Feature Store): {registered_model_name_non_fs}")
print(f"Model Name(With Feature Store): {registered_model_name_fs}")
print(f"***************************************************")
